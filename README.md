...
<p align="center">
  <a href="https://bytamer.com/forex"><img alt="EA" src="https://img.shields.io/badge/MT5%20EA-BTFX--3.9-f7b955?style=for-the-badge&logo=metafilter"></a>
...
|---------|------|-------------|
| **BTFX-3.9** | **2026-09-24** | **Grid and balance engines no longer stack — a balance leg waits 60 s after any grid leg opens, so the two never enter the same side at the same price.** |
...
| v7.9.9–12 | 2026-07-16 | USTEC calibration (lot 0.02→0.08+, spread 350) + session hours (metal/forex end 23 TR, indices end 02 TR) + NightModeMinProfit 0.50→3.00 |
| **v7.9.7** | **2026-07-16** | **SPM trigger uniform -4 across profiles (ATR-normalized analysis; XAG churn fix — 41 trades/+$5 → quality entries). BTC kept at -5 deliberately** |
